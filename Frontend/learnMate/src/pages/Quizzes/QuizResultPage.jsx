    ...
    <div className='max-w-5xl mx-auto'>
       ...
       <div className='mb-6'>
        <Link
         ...
         className='group inline-flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-emerald-600 transition-colors duration-200'
        >
       ...
       <div className='space-y-6'>
         ...
         {detailedResults.map((result,index) => {
          //  const userAnswereIndex = result.options.findIndex(opt => opt === result.selectedAnswere);
          //  const correctAnswereIndex = result.correctAnswers.startsWith('0')
              ...
              >
                ...
                <div className='space-y-3 mb-4'>
                   {result.options.map((option,optIndex) => {
                    // const isCorrectOption = optIndex === correctAnswereIndex;
                    // const isUserAnswer = optIndex === userAnswereIndex;
