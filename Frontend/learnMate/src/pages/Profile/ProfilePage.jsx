...
const ProfilePage = () => {
  ...
  const handleChangePassword = async (e) => {
     ...
     try {
      ...
      toast.success('Paasword changed successfully!');
      setCurrentPassword("");
      setNewPassword("")
                  ...
                  <div>
                   ...
                   <div>
                    ...
                    <div className='relative'>
                      ...
                      required
                      className='w-full h-9 pl-9 border border-neutral-900 rounded-lg bg-white text-sm  text-neutral-900 placeholder-neutral-400 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent'
                      />
                    </div>
                   </div>
