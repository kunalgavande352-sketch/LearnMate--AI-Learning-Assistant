...
const QuizManager = ({documentId}) => {
    ...
    useEffect(() => {
          ...
          console.log("QuizManager mounted");
    console.log("documentId:", documentId);
               
        if(documentId){
            console.log("Calling fetchQuizzes");
            fetchQuizzes();
        }
    },[documentId]);
    ...
    const renderQuizContent = () => {
        ...
        if(quizzes.length === 0){
            return (
                ...
                description="Generate a quiz from your document to test your knowladge"
                />
            );
        }
  ...
  return (
      <div className='bg-white border border-neutral-200 rounded-lg p-6'>
        ...
        >
            <form onSubmit={handleGenerateQuiz} className='sapce-y-4'>
                <div>
        ...
        title="Confirmation Delete Quiz"
        >
