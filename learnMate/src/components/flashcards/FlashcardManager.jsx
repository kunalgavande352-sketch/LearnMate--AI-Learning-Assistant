     ...
     if(flashcardSets.length === 0){
         ...
         <div className='flex flex-col items-center justify-center py-16 px-6'>
              ...
              <p className='text-sm text-slate-500 mb-8 text-center max-w-sm'>
                Generate flashcard from your document to start learing and rainforce your knowledge.
              </p>
              <button
     ...
     return (
         <div className='space-y-6'>
           ...
           <div className='flex items-center justify-between'>
             ...
             onClick={handleGenerateFlashcard}
             disabled={generating}
             className='group inline-flex items-center gap-2 px-5 h-11 bg-linear-to-br from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:100'
             >
              {generating ? (
                <>
                  <div className='w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
               {flashcardSets.map((set) => (
                 <div
                  ...
                  className='group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/100'
                 >
                  {/* Delete Button */}
                  <button
                  ...
                  {/* Set Content */}
                   <div className='space-y-4'>
                     <div className='inline-flex items-center justify-center w-12 h-12 rounded-lg bg-linear-to-br from-emerald-100 to-teal-100'>
